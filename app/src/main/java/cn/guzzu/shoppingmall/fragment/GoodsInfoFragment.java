...
import cn.guzzu.shoppingmall.widget.MyScrollView;
import cn.guzzu.shoppingmall.widget.SlideDetailsLayout;
...
//        tv_goods_config = (TextView) rootView.findViewById(R.id.tv_goods_config);
    ...
    private void initBanner() {
        ...
        if (product.getImage() != null) {
            ...
            //设置图片集合并加载图片
            banner.setImages(product_img).setImageLoader(new ImageLoader() {
                @Override
