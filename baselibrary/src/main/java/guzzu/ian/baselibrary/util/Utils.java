...
import guzzu.ian.baselibrary.R;
...
public class Utils {
     ...
     * @param cls
     */
    public static void start_Activity(Context activity, Class<?> cls, String key, String value) {
        Intent intent = new Intent();
        intent.setClass(activity, cls);
     ...
     * @param cls
     */
    public static void start_Activity(Activity activity, Class<?> cls, String key, String value) {
        Intent intent = new Intent();
        intent.setClass(activity, cls);
        intent.putExtra(key,value);
        activity.startActivity(intent);
